    ...
    missions: [
      {
        ...
        story: "⚠️ INCIDENT: Someone committed the .env file with API keys. Even after deleting, it's in Git history. How do we handle this?",
...
const totalMissions = chapters.reduce((sum, ch) => sum + ch.missions.length, 0);
...
// Sandbox Component (abbreviated for length)
